// tailwind.config.ts — Padvik Purple Theme
// Copy this to root during project scaffold
  ...
  theme: {
    extend: {
      colors: {
        ...
        // Padvik semantic colors for education
        ...
        // Direct purple palette for custom use
        violet: {
          50: "#F5F3FF",
          100: "#EDE9FE",
          200: "#DDD6FE",
