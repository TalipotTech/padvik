...
/**
 * Dashboard-scoped Explore page — content browser for logged-in users.
 * Inherits the dashboard layout (sidebar, header). Links to /dashboard/content/[id]
 * so students stay inside the authenticated shell.
 */
export function DashboardExplore() {
  ...
  }, [search, contentType, boardId, page]);
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Discover educational content from our creator community
        </p>
      ...
      {featuredCreators.length > 0 && !search && page === 1 && (
        <div>
          <h2 className="text-base font-semibold mb-3">Featured Educators</h2>
